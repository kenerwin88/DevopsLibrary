<?php get_header(); ?>
<body class="homepage_index" data-action="index" data-controller="homepage" itemscope="" itemtype="http://schema.org/WebPage" data-twttr-rendered="true">
		<header>
			<ul class="navbar">
				<li>
				...
				<li>
					<form action="http://www.devopslibrary.com/search" id="search">
						<input autocomplete="off" class="search-query ui-autocomplete-input" id="term" name="term" placeholder="Search Videos &amp; Guides" type="text" role="textbox" aria-autocomplete="list" aria-haspopup="true">
						<a class="search-submit-link" href="http://www.devopslibrary.com/#"><i class="icon2-search"></i>Search</a>
      ...
      <div class="content"><div class="carousel">
        <div class="main">
          <h2>
            Featured Tutorials
          </h2>
          <ol class="dots"><li data-i="0" class="">
            <a href="http://www.devopslibrary.com/" title="Temp"></a>
          </li><li data-i="1" class="">
          <a href="http://www.devopslibrary.com" title="Temp"></a>
        </li><li data-i="2">
        <a href="http://www.devopslibrary.com" title="Temp"></a>
      </li><li data-i="3">
  ...
  <div class="icon-overlay"><div class="category-icon dance" style="display: none;"></div><div class="category-icon parenting" style="display: none;"></div><div class="category-icon dance" style="display: block;"></div><div class="category-icon food" style="display: none;"></div><div class="category-icon health" style="display: none;"></div></div>
  <div class="window">
    <ol style="left: -2910px;"><li class="">
      <a href="http://www.devopslibrary.com/Temp" title="Temp">
        ...
        <img alt="Weight Loss Tips" src="<?php bloginfo('stylesheet_directory'); ?>/images/chef2.jpg">
    ...
    <a href="http://www.devopslibrary.com" title="Temp">
      ...
      <div class="video-thumb">
        <img alt="How to Enjoy Winter" src="<?php bloginfo('stylesheet_directory'); ?>/images/docker.jpg">
        <span class="play"></span>
      </div>
    </a>
  </li><li class="">
  <a href="http://www.devopslibrary.com/" title="Temp">
    ...
    <div class="video-thumb">
      <img alt="Christmas Gift Guide" src="<?php bloginfo('stylesheet_directory'); ?>/images/jenkins.jpg">
      <span class="play"></span>
    </div>
  </a>
</li><li class="">
<a href="http://www.devopslibrary.com/" title="Temp">
  ...
  <div class="video-thumb">
    <img alt="Temp" src="<?php bloginfo('stylesheet_directory'); ?>/images/githubdumped3.jpg">
    <span class="play"></span>
  </div>
</a>
</li><li class="">
<a href="http://www.devopslibrary.com" title="Temp">
  ...
  <div class="video-thumb">
    <img alt="How to Make Candy" src="<?php bloginfo('stylesheet_directory'); ?>/images/elk.jpg">
    <span class="play"></span>
  </div>
</a>
</li></ol>
...
<div class="overlay">
  ...
  <ol><li style="display: none;">
    <h3>Are you good in the kitchen?  Fortunately this time it doesn’t matter, you’ll be mixing up Chef recipes before you know it!</h3>
    <div class="watch"><a href="http://www.devopslibrary.com/" title="Temp">View Tutorial ▸</a></div>
  </li><li style="display: none;">
  <h3>We'll sail into the harbour no prouder man there'll be.  We'll show them all that docker rocks and really is easy. </h3>
  <div class="watch"><a href="http://www.devopslibrary.com" title="Temp">View Tutorial ▸</a></div>
</li><li style="display: list-item;">
<h3>Jenkins isn't just for developers!  Make your scripts easy to reuse, run, and test with our favorite butler! </h3>
<div class="watch"><a href="http://www.devopslibrary.com/" title="Temp">View Tutorial ▸</a></div>
</li><li style="display: none;">
<h3>Version control is about saving your future self today or: How I learned to stop worrying and love the Github.</h3>
<div class="watch"><a href="http://www.devopslibrary.com/" title="Temp">View Tutorial ▸</a></div>
</li><li style="display: none;">
<h3>What do you get when you combine Elasticsearch, Logstash, and Kibana?  An amazing (and free) logging platform. </h3>
<div class="watch"><a href="http://www.devopslibrary.com" title="Temp">View Tutorial ▸</a></div>
</li></ol>
      ...
      <div class="col">
        <div class="big-topic">
          ...
          <a href="http://www.devopslibrary.com/Temp" title="Coming Soon">
            <div class="content">
              <span class="video-thumb"><img alt="Temp" height="160" src="<?php bloginfo('stylesheet_directory'); ?>/images/elk.jpg" width="280"><span class="play"></span></span>
              ...
              <p>Learn how to set up the ELK stack from the ground up, a perfect free logging platform.</p>
    ...
    <div id="big-topic-column">
      <div class="col">
        <div class="big-topic">
          ...
          <a href="http://www.devopslibrary.com/" title="Temp">
            <div class="content">
              <span class="video-thumb"><img alt="Temp" height="160" src="<?php bloginfo('stylesheet_directory'); ?>/images/githubdumped3.jpg" width="280"><span class="play"></span></span>
...
<li class="google-plus">Google Plus Placeholder<div class="g-plusone" data-size="medium" data-annotation="inline" data-width="300"></div>
</li>
<li class="youtube-subscribe">
<div class="g-ytsubscribe" data-channelid="UC3q80yTlbGzoYZFoTLQPTJw" data-layout="default" data-count="default"></div>
</li>
</ul>
</div>
</div>
...
<script>
 ...
 _qevents.push({
  ...
  //]]>
</script><iframe src="images/container.html" style="visibility: hidden; display: none;"></iframe>
<noscript>
